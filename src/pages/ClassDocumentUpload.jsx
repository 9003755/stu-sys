...
import { Camera, CheckCircle2, ImagePlus, LoaderCircle, ShieldCheck, X } from 'lucide-react'
...
function CameraDialog({ title, onClose, onCapture }) {
  ...
  useEffect(() => {
    ...
    navigator.mediaDevices?.getUserMedia({ video: { facingMode: { ideal: 'environment' }, width: { ideal: 3840 }, height: { ideal: 2160 } }, audio: false })
      ...
      .catch(() => setError('无法打开相机，请允许浏览器使用相机，或改为从相册上传。'))
